## Security Policy – GridPilot for Jira

### Overview

Security is a core priority of GridPilot for Jira. The application is built using modern security practices and leverages Atlassian Forge infrastructure where possible.
